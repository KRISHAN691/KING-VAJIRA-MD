...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : '94764224187';
...
global.email = 'krishanxsl@gmail.com' ;
global.location = 'Rathnapura SriLanka' ;
global.timezone  = process.env.TIME_ZONE || 'Asia/Colombo'
global.gurl = 'https://youtube.com/@alexgaming7548' ; // add your username
...
module.exports = {
  sessionName: process.env.SESSION_ID || "VAJIRA;;;VialsBrethren",      //Put Your Session Id Here
  botname: process.env.BOT_NAME || 'KRISHAN-ᴍᴅ',
  botbgm: process.env.BOT_BGM || 'false',
  ownername:  process.env.OWNER_NAME || `It'x KRISHAN`,
